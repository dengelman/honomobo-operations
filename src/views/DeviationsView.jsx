    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Total Deviations</p>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Project Deviations</h2>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {deviations.map((deviation) => (
                <tr key={deviation.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{deviation.project}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{deviation.type}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs rounded-full ${getSeverityColor(deviation.severity)}`}>{deviation.severity}</span>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-500">{deviation.description}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2">{getStatusIcon(deviation.status)}<span className="text-sm">{deviation.status}</span></div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{deviation.date}</td>
                </tr>
              ))}
            </tbody>
          </table>
